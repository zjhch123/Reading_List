...
3. [Node.js学习笔记与经验](https://github.com/chyingp/nodejs-learning-guide)
4. [如何正确学习Node.js](https://github.com/i5ting/How-to-learn-node-correctly)
...
### Java
1. [Java 核心知识库](https://github.com/crossoverJie/JCSprout)
### CSS
